...
class Hub:
    """Central communication manager for OpenDisplay integration.

    This class manages all interaction with the OEPL Access Point (AP),
    including:
    ...
    Attributes:
        ...
        host: Hostname or IP of the OEPL AP
    ...
    async def _handle_shutdown(self, _) -> None:
        ...
        """
        _LOGGER.debug("Processing shutdown for OEPL hub")
        await self.shutdown()
    ...
    async def shutdown(self) -> None:
        ...
        """
        _LOGGER.debug("Shutting down OEPL hub")
        ...
        _LOGGER.debug("OEPL hub shutdown complete")
    ...
    async def _websocket_handler(self) -> None:
        """Handle WebSocket connection lifecycle and process messages.
         ...
         connection to the OEPL Access Point, including:
    ...
    async def _handle_message(self, message: str) -> None:
        ...
        try:
            ...
            if "sys" in data:
                ...
                _LOGGER.debug("OpenDisplay Log message: %s", data["logMsg"])
    ...
    def _format_ap_model(ap_env: str) -> str:
        ...
        model_mapping = {
            ...
            "OpenDisplay_Mini_AP_v4": "Mini AP v4",
            "OpenDisplay_ESP32-PoE-ISO_AP": "PoE ISO AP",
            "ESP32_S3_16_8_LILYGO_AP": "LilyGo T-Panel S3",
            "OpenDisplay_AP_and_Flasher": "AP and Flasher",
            "OpenDisplay_PoE_AP": "PoE AP",
            "BLE_ONLY_AP": "BLE only AP",
            "OpenDisplay_Nano_TLSR": "Nano TLSR AP",
