...
class BLEProtocol(ABC):
    ...
    Each firmware type (ATC, OpenDisplay) implements this interface to provide
    ...
    def protocol_name(self) -> str:
        """Protocol identifier: 'atc' or 'open_display'."""
    ...
    async def interrogate_device(
        ...
        For OpenDisplay: Reads full config via 0x0040, extracts display dimensions.
