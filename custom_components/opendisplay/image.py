...
from .entity import OpenDisplayTagEntity, OpenDisplayBLEEntity
...
async def async_setup_entry(
    ...
    """Set up the OpenDisplay image platform."""
    ...
    if is_ble_entry(entry_data):
        ...
        image_entity = OpenDisplayBLEImage(
            hass=hass,
...
class ESLImage(OpenDisplayTagEntity, ImageEntity):
    """Image entity class for OpenDisplay tags.
    ...
    def __init__(self, hass: HomeAssistant, tag_mac: str, hub) -> None:
        ...
        OpenDisplayTagEntity.__init__(self, hub, tag_mac)
...
class OpenDisplayBLEImage(OpenDisplayBLEEntity, ImageEntity):
    """Image entity for BLE OpenDisplay devices.
